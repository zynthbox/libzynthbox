...
```
apt install extra-cmake-modules libkf5pty-dev qtbase5-dev kirigami2-dev qtdeclarative5-dev librtmidi-dev libwebkit2gtk-4.1-dev libpyside2-dev libshiboken2-dev libclang-dev llvm-dev libappimage-dev qtquickcontrols2-5-dev libqt5svg5-dev libkf5plasma-dev qtbase5-private-dev qtdeclarative5-private-dev
```
