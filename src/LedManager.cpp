...
void LedManager::setButtonMenuColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonMenu) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonMenu, color);
        Q_EMIT buttonMenuColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonMenu, color);
    }
}
...
void LedManager::setButtonNum1Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonNum1) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonNum1, color);
        Q_EMIT buttonNum1ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonNum1, color);
    }
}
...
void LedManager::setButtonNum2Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonNum2) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonNum2, color);
        Q_EMIT buttonNum2ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonNum2, color);
    }
}
...
void LedManager::setButtonNum3Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonNum3) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonNum3, color);
        Q_EMIT buttonNum3ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonNum3, color);
    }
}
...
void LedManager::setButtonNum4Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonNum4) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonNum4, color);
        Q_EMIT buttonNum4ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonNum4, color);
    }
}
...
void LedManager::setButtonNum5Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonNum5) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonNum5, color);
        Q_EMIT buttonNum5ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonNum5, color);
    }
}
...
void LedManager::setButtonStarColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStar) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStar, color);
        Q_EMIT buttonStarColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStar, color);
    }
}
...
void LedManager::setButtonModeColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonMode) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonMode, color);
        Q_EMIT buttonModeColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonMode, color);
    }
}
...
void LedManager::setButtonStep1Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep1) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep1, color);
        Q_EMIT buttonStep1ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep1, color);
    }
}
...
void LedManager::setButtonStep2Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep2) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep2, color);
        Q_EMIT buttonStep2ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep2, color);
    }
}
...
void LedManager::setButtonStep3Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep3) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep3, color);
        Q_EMIT buttonStep3ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep3, color);
    }
}
...
void LedManager::setButtonStep4Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep4) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep4, color);
        Q_EMIT buttonStep4ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep4, color);
    }
}
...
void LedManager::setButtonStep5Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep5) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep5, color);
        Q_EMIT buttonStep5ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep5, color);
    }
}
...
void LedManager::setButtonStep6Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep6) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep6, color);
        Q_EMIT buttonStep6ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep6, color);
    }
}
...
void LedManager::setButtonStep7Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep7) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep7, color);
        Q_EMIT buttonStep7ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep7, color);
    }
}
...
void LedManager::setButtonStep8Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep8) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep8, color);
        Q_EMIT buttonStep8ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep8, color);
    }
}
...
void LedManager::setButtonStep9Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep9) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep9, color);
        Q_EMIT buttonStep9ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep9, color);
    }
}
...
void LedManager::setButtonStep10Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep10) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep10, color);
        Q_EMIT buttonStep10ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep10, color);
    }
}
...
void LedManager::setButtonStep11Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep11) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep11, color);
        Q_EMIT buttonStep11ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep11, color);
    }
}
...
void LedManager::setButtonStep12Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep12) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep12, color);
        Q_EMIT buttonStep12ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep12, color);
    }
}
...
void LedManager::setButtonStep13Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep13) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep13, color);
        Q_EMIT buttonStep13ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep13, color);
    }
}
...
void LedManager::setButtonStep14Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep14) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep14, color);
        Q_EMIT buttonStep14ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep14, color);
    }
}
...
void LedManager::setButtonStep15Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep15) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep15, color);
        Q_EMIT buttonStep15ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep15, color);
    }
}
...
void LedManager::setButtonStep16Color(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStep16) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStep16, color);
        Q_EMIT buttonStep16ColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStep16, color);
    }
}
...
void LedManager::setButtonAltColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonAlt) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonAlt, color);
        Q_EMIT buttonAltColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonAlt, color);
    }
}
...
void LedManager::setButtonRecordColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonRecord) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonRecord, color);
        Q_EMIT buttonRecordColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonRecord, color);
    }
}
...
void LedManager::setButtonPlayColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonPlay) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonPlay, color);
        Q_EMIT buttonPlayColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonPlay, color);
    }
}
...
void LedManager::setButtonMetronomeColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonMetronome) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonMetronome, color);
        Q_EMIT buttonMetronomeColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonMetronome, color);
    }
}
...
void LedManager::setButtonStopColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonStop) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonStop, color);
        Q_EMIT buttonStopColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonStop, color);
    }
}
...
void LedManager::setButtonBackColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonBack) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonBack, color);
        Q_EMIT buttonBackColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonBack, color);
    }
}
...
void LedManager::setButtonUpColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonUp) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonUp, color);
        Q_EMIT buttonUpColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonUp, color);
    }
}
...
void LedManager::setButtonSelectColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonSelect) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonSelect, color);
        Q_EMIT buttonSelectColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonSelect, color);
    }
}
...
void LedManager::setButtonLeftColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonLeft) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonLeft, color);
        Q_EMIT buttonLeftColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonLeft, color);
    }
}
...
void LedManager::setButtonDownColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonDown) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonDown, color);
        Q_EMIT buttonDownColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonDown, color);
    }
}
...
void LedManager::setButtonRightColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonRight) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonRight, color);
        Q_EMIT buttonRightColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonRight, color);
    }
}
...
void LedManager::setButtonGlobalColor(QColor &color) {
    if (d->buttonColors.value(ZynthboxBasics::Button::ButtonGlobal) != color) {
        d->buttonColors.insert(ZynthboxBasics::Button::ButtonGlobal, color);
        Q_EMIT buttonGlobalColorChanged();
        Q_EMIT ledColorChanged(ZynthboxBasics::Button::ButtonGlobal, color);
    }
}

void LedManager::resetColor(ZynthboxBasics::Button button) {
...
void LedManager::resetAllColors() {
    QColor noColor;
...
QVariantMap LedManager::ledColors() const {
    ...
    for (auto it = d->buttonColors.constBegin(); it != d->buttonColors.constEnd(); ++it) {
        colors.insert(QString::number(static_cast<int>(it.key())), it.value());
    }
    return colors;
}