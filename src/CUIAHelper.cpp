...
public:
    ...
    const QHash<CUIAHelper::Event, QString> titles{
        ...
        {CUIAHelper::StartPlaybackEvent, QLatin1String{"Start Playback"}},
        {CUIAHelper::StopPlaybackEvent, QLatin1String{"Stop Playback"}},
        {CUIAHelper::StartRecordingEvent, QLatin1String{"Start Recording"}},
        {CUIAHelper::StopRecordingEvent, QLatin1String{"Stop Recording"}},
        ...
        {CUIAHelper::SwitchRecordPressedEvent, QLatin1String{"Press Record Button"}},
        {CUIAHelper::SwitchRecordReleasedEvent, QLatin1String{"Release Record Button"}},
        {CUIAHelper::SelectItemEvent, QLatin1String{"Activate Item At Position"}},
        {CUIAHelper::SwitchArrowUpPressedEvent, QLatin1String{"Press Arrow Up Button"}},
        {CUIAHelper::SwitchArrowUpReleasedEvent, QLatin1String{"Release Arrow Up Button"}},
        {CUIAHelper::SwitchArrowDownPressedEvent, QLatin1String{"Press Arrow Down Button"}},
        {CUIAHelper::SwitchArrowDownReleasedEvent, QLatin1String{"Release Arrow Down Button"}},
        {CUIAHelper::SwitchArrowLeftPressedEvent, QLatin1String{"Press Arrow Left Button"}},
        {CUIAHelper::SwitchArrowLeftReleasedEvent, QLatin1String{"Release Arrow Left Button"}},
        {CUIAHelper::SwitchArrowRightPressedEvent, QLatin1String{"Press Arrow Right Button"}},
        {CUIAHelper::SwitchArrowRightReleasedEvent, QLatin1String{"Release Arrow Right Button"}},
        ...
        {CUIAHelper::SwitchBackPressedEvent, QLatin1String{"Press Back Button"}},
        {CUIAHelper::SwitchBackReleasedEvent, QLatin1String{"Release Back Button"}},
        ...
        {CUIAHelper::SwitchSelectPressedEvent, QLatin1String{"Press Select Button"}},
        {CUIAHelper::SwitchSelectReleasedEvent, QLatin1String{"Release Select Button"}},
        {CUIAHelper::SwitchStarPressedEvent, QLatin1String{"Press Star Button"}},
        {CUIAHelper::SwitchStarReleasedEvent, QLatin1String{"Release Star Button"}},
        {CUIAHelper::SwitchStep1PressedEvent, QLatin1String{"Press Step 1 Button"}},
        {CUIAHelper::SwitchStep1ReleasedEvent, QLatin1String{"Release Step 1 Button"}},
        {CUIAHelper::SwitchStep2PressedEvent, QLatin1String{"Press Step 2 Button"}},
        {CUIAHelper::SwitchStep2ReleasedEvent, QLatin1String{"Release Step 2 Button"}},
        {CUIAHelper::SwitchStep3PressedEvent, QLatin1String{"Press Step 3 Button"}},
        {CUIAHelper::SwitchStep3ReleasedEvent, QLatin1String{"Release Step 3 Button"}},
        {CUIAHelper::SwitchStep4PressedEvent, QLatin1String{"Press Step 4 Button"}},
        {CUIAHelper::SwitchStep4ReleasedEvent, QLatin1String{"Release Step 4 Button"}},
        {CUIAHelper::SwitchStep5PressedEvent, QLatin1String{"Press Step 5 Button"}},
        {CUIAHelper::SwitchStep5ReleasedEvent, QLatin1String{"Release Step 5 Button"}},
        {CUIAHelper::SwitchStep6PressedEvent, QLatin1String{"Press Step 6 Button"}},
        {CUIAHelper::SwitchStep6ReleasedEvent, QLatin1String{"Release Step 6 Button"}},
        {CUIAHelper::SwitchStep7PressedEvent, QLatin1String{"Press Step 7 Button"}},
        {CUIAHelper::SwitchStep7ReleasedEvent, QLatin1String{"Release Step 7 Button"}},
        {CUIAHelper::SwitchStep8PressedEvent, QLatin1String{"Press Step 8 Button"}},
        {CUIAHelper::SwitchStep8ReleasedEvent, QLatin1String{"Release Step 8 Button"}},
        {CUIAHelper::SwitchStep9PressedEvent, QLatin1String{"Press Step 9 Button"}},
        {CUIAHelper::SwitchStep9ReleasedEvent, QLatin1String{"Release Step 9 Button"}},
        {CUIAHelper::SwitchStep10PressedEvent, QLatin1String{"Press Step 10 Button"}},
        {CUIAHelper::SwitchStep10ReleasedEvent, QLatin1String{"Release Step 10 Button"}},
        {CUIAHelper::SwitchStep11PressedEvent, QLatin1String{"Press Step 11 Button"}},
        {CUIAHelper::SwitchStep11ReleasedEvent, QLatin1String{"Release Step 11 Button"}},
        {CUIAHelper::SwitchStep12PressedEvent, QLatin1String{"Press Step 12 Button"}},
        {CUIAHelper::SwitchStep12ReleasedEvent, QLatin1String{"Release Step 12 Button"}},
        {CUIAHelper::SwitchStep13PressedEvent, QLatin1String{"Press Step 13 Button"}},
        {CUIAHelper::SwitchStep13ReleasedEvent, QLatin1String{"Release Step 13 Button"}},
        {CUIAHelper::SwitchStep14PressedEvent, QLatin1String{"Press Step 14 Button"}},
        {CUIAHelper::SwitchStep14ReleasedEvent, QLatin1String{"Release Step 14 Button"}},
        {CUIAHelper::SwitchStep15PressedEvent, QLatin1String{"Press Step 15 Button"}},
        {CUIAHelper::SwitchStep15ReleasedEvent, QLatin1String{"Release Step 15 Button"}},
        {CUIAHelper::SwitchStep16PressedEvent, QLatin1String{"Press Step 16 Button"}},
        {CUIAHelper::SwitchStep16ReleasedEvent, QLatin1String{"Release Step 16 Button"}},
        {CUIAHelper::SwitchAltPressedEvent, QLatin1String{"Press Alt Button"}},
        {CUIAHelper::SwitchAltReleasedEvent, QLatin1String{"Release Alt Button"}},
        {CUIAHelper::SwitchRecordPressedEvent, QLatin1String{"Press Record Button"}},
        {CUIAHelper::SwitchRecordReleasedEvent, QLatin1String{"Release Record Button"}},
        {CUIAHelper::SwitchMetronomePressedEvent, QLatin1String{"Press Metronome Button"}},
        {CUIAHelper::SwitchMetronomeReleasedEvent, QLatin1String{"Release Metronome Button"}},
        {CUIAHelper::SwitchPlayPressedEvent, QLatin1String{"Press Play Button"}},
        {CUIAHelper::SwitchPlayReleasedEvent, QLatin1String{"Release Play Button"}},
        {CUIAHelper::SwitchStopPressedEvent, QLatin1String{"Press Stop Button"}},
        {CUIAHelper::SwitchStopReleasedEvent, QLatin1String{"Release Stop Button"}},
        ...
        {CUIAHelper::SwitchMenuPressedEvent, QLatin1String{"Press Menu Button"}},
        {CUIAHelper::SwitchMenuReleasedEvent, QLatin1String{"Release Menu Button"}},
        {CUIAHelper::SwitchNumber1PressedEvent, QLatin1String{"Press Number 1 Button"}},
        {CUIAHelper::SwitchNumber1ReleasedEvent, QLatin1String{"Release Number 1 Button"}},
        {CUIAHelper::SwitchNumber2PressedEvent, QLatin1String{"Press Number 2 Button"}},
        {CUIAHelper::SwitchNumber2ReleasedEvent, QLatin1String{"Release Number 2 Button"}},
        {CUIAHelper::SwitchNumber3PressedEvent, QLatin1String{"Press Number 3 Button"}},
        {CUIAHelper::SwitchNumber3ReleasedEvent, QLatin1String{"Release Number 3 Button"}},
        {CUIAHelper::SwitchNumber4PressedEvent, QLatin1String{"Press Number 4 Button"}},
        {CUIAHelper::SwitchNumber4ReleasedEvent, QLatin1String{"Release Number 4 Button"}},
        {CUIAHelper::SwitchNumber5PressedEvent, QLatin1String{"Press Number 5 Button"}},
        {CUIAHelper::SwitchNumber5ReleasedEvent, QLatin1String{"Release Number 5 Button"}},
        {CUIAHelper::SwitchModePressedEvent, QLatin1String{"Press Mode Button"}},
        ...
        {CUIAHelper::SwitchGlobalPressedEvent, QLatin1String{"Press Global Button"}},
        ...
        {CUIAHelper::SwitchKnob3PressedEvent, QLatin1String{"Knob 4: Pressed"}},
    ...
    const QHash<CUIAHelper::Event, QString> commands{
        ...
        {CUIAHelper::StartPlaybackEvent, QLatin1String{"START_PLAYBACK"}},
        {CUIAHelper::StopPlaybackEvent, QLatin1String{"STOP_PLAYBACK"}},
        {CUIAHelper::StartRecordingEvent, QLatin1String{"START_RECORDING"}},
        {CUIAHelper::StopRecordingEvent, QLatin1String{"STOP_RECORDING"}},
        ...
        {CUIAHelper::SwitchArrowLeftPressedEvent, QLatin1String{"SWITCH_ARROW_LEFT_PRESSED"}},
        {CUIAHelper::SwitchArrowLeftReleasedEvent, QLatin1String{"SWITCH_ARROW_LEFT_RELEASED"}},
        {CUIAHelper::SwitchArrowRightPressedEvent, QLatin1String{"SWITCH_ARROW_RIGHT_PRESSED"}},
        {CUIAHelper::SwitchArrowRightReleasedEvent, QLatin1String{"SWITCH_ARROW_RIGHT_RELEASED"}},
        ...
        {CUIAHelper::SwitchBackPressedEvent, QLatin1String{"SWITCH_BACK_PRESSED"}},
        {CUIAHelper::SwitchBackReleasedEvent, QLatin1String{"SWITCH_BACK_RELEASED"}},
        ...
        {CUIAHelper::SwitchSelectPressedEvent, QLatin1String{"SWITCH_SELECT_PRESSED"}},
        {CUIAHelper::SwitchSelectReleasedEvent, QLatin1String{"SWITCH_SELECT_RELEASED"}},
        {CUIAHelper::SwitchModePressedEvent, QLatin1String{"SWITCH_MODE_PRESSED"}},
        {CUIAHelper::SwitchModeReleasedEvent, QLatin1String{"SWITCH_MODE_RELEASED"}},
        {CUIAHelper::SwitchStarPressedEvent, QLatin1String{"SWITCH_STAR_PRESSED"}},
        {CUIAHelper::SwitchStarReleasedEvent, QLatin1String{"SWITCH_STAR_RELEASED"}},
        {CUIAHelper::SwitchStep1PressedEvent, QLatin1String{"SWITCH_STEP1_PRESSED"}},
        {CUIAHelper::SwitchStep1ReleasedEvent, QLatin1String{"SWITCH_STEP1_RELEASED"}},
        {CUIAHelper::SwitchStep2PressedEvent, QLatin1String{"SWITCH_STEP2_PRESSED"}},
        {CUIAHelper::SwitchStep2ReleasedEvent, QLatin1String{"SWITCH_STEP2_RELEASED"}},
        {CUIAHelper::SwitchStep3PressedEvent, QLatin1String{"SWITCH_STEP3_PRESSED"}},
        {CUIAHelper::SwitchStep3ReleasedEvent, QLatin1String{"SWITCH_STEP3_RELEASED"}},
        {CUIAHelper::SwitchStep4PressedEvent, QLatin1String{"SWITCH_STEP4_PRESSED"}},
        {CUIAHelper::SwitchStep4ReleasedEvent, QLatin1String{"SWITCH_STEP4_RELEASED"}},
        {CUIAHelper::SwitchStep5PressedEvent, QLatin1String{"SWITCH_STEP5_PRESSED"}},
        {CUIAHelper::SwitchStep5ReleasedEvent, QLatin1String{"SWITCH_STEP5_RELEASED"}},
        {CUIAHelper::SwitchStep6PressedEvent, QLatin1String{"SWITCH_STEP6_PRESSED"}},
        {CUIAHelper::SwitchStep6ReleasedEvent, QLatin1String{"SWITCH_STEP6_RELEASED"}},
        {CUIAHelper::SwitchStep7PressedEvent, QLatin1String{"SWITCH_STEP7_PRESSED"}},
        {CUIAHelper::SwitchStep7ReleasedEvent, QLatin1String{"SWITCH_STEP7_RELEASED"}},
        {CUIAHelper::SwitchStep8PressedEvent, QLatin1String{"SWITCH_STEP8_PRESSED"}},
        {CUIAHelper::SwitchStep8ReleasedEvent, QLatin1String{"SWITCH_STEP8_RELEASED"}},
        {CUIAHelper::SwitchStep9PressedEvent, QLatin1String{"SWITCH_STEP9_PRESSED"}},
        {CUIAHelper::SwitchStep9ReleasedEvent, QLatin1String{"SWITCH_STEP9_RELEASED"}},
        {CUIAHelper::SwitchStep10PressedEvent, QLatin1String{"SWITCH_STEP10_PRESSED"}},
        {CUIAHelper::SwitchStep10ReleasedEvent, QLatin1String{"SWITCH_STEP10_RELEASED"}},
        {CUIAHelper::SwitchStep11PressedEvent, QLatin1String{"SWITCH_STEP11_PRESSED"}},
        {CUIAHelper::SwitchStep11ReleasedEvent, QLatin1String{"SWITCH_STEP11_RELEASED"}},
        {CUIAHelper::SwitchStep12PressedEvent, QLatin1String{"SWITCH_STEP12_PRESSED"}},
        {CUIAHelper::SwitchStep12ReleasedEvent, QLatin1String{"SWITCH_STEP12_RELEASED"}},
        {CUIAHelper::SwitchStep13PressedEvent, QLatin1String{"SWITCH_STEP13_PRESSED"}},
        {CUIAHelper::SwitchStep13ReleasedEvent, QLatin1String{"SWITCH_STEP13_RELEASED"}},
        {CUIAHelper::SwitchStep14PressedEvent, QLatin1String{"SWITCH_STEP14_PRESSED"}},
        {CUIAHelper::SwitchStep14ReleasedEvent, QLatin1String{"SWITCH_STEP14_RELEASED"}},
        {CUIAHelper::SwitchStep15PressedEvent, QLatin1String{"SWITCH_STEP15_PRESSED"}},
        {CUIAHelper::SwitchStep15ReleasedEvent, QLatin1String{"SWITCH_STEP15_RELEASED"}},
        {CUIAHelper::SwitchStep16PressedEvent, QLatin1String{"SWITCH_STEP16_PRESSED"}},
        {CUIAHelper::SwitchStep16ReleasedEvent, QLatin1String{"SWITCH_STEP16_RELEASED"}},
        {CUIAHelper::SwitchAltPressedEvent, QLatin1String{"SWITCH_ALT_PRESSED"}},
        {CUIAHelper::SwitchAltReleasedEvent, QLatin1String{"SWITCH_ALT_RELEASED"}},
        {CUIAHelper::SwitchRecordPressedEvent, QLatin1String{"SWITCH_RECORD_PRESSED"}},
        {CUIAHelper::SwitchRecordReleasedEvent, QLatin1String{"SWITCH_RECORD_RELEASED"}},
        {CUIAHelper::SwitchMetronomePressedEvent, QLatin1String{"SWITCH_METRONOME_PRESSED"}},
        {CUIAHelper::SwitchMetronomeReleasedEvent, QLatin1String{"SWITCH_METRONOME_RELEASED"}},
        {CUIAHelper::SwitchPlayPressedEvent, QLatin1String{"SWITCH_PLAY_PRESSED"}},
        {CUIAHelper::SwitchPlayReleasedEvent, QLatin1String{"SWITCH_PLAY_RELEASED"}},
        {CUIAHelper::SwitchStopPressedEvent, QLatin1String{"SWITCH_STOP_PRESSED"}},
        {CUIAHelper::SwitchStopReleasedEvent, QLatin1String{"SWITCH_STOP_RELEASED"}},
        ...
        {CUIAHelper::SwitchMenuPressedEvent, QLatin1String{"SWITCH_MENU_PRESSED"}},
        {CUIAHelper::SwitchMenuReleasedEvent, QLatin1String{"SWITCH_MENU_RELEASED"}},
        {CUIAHelper::SwitchNumber1PressedEvent, QLatin1String{"SWITCH_NUMBER_1_PRESSED"}},
        {CUIAHelper::SwitchNumber1ReleasedEvent, QLatin1String{"SWITCH_NUMBER_1_RELEASED"}},
        {CUIAHelper::SwitchNumber2PressedEvent, QLatin1String{"SWITCH_NUMBER_2_PRESSED"}},
        {CUIAHelper::SwitchNumber2ReleasedEvent, QLatin1String{"SWITCH_NUMBER_2_RELEASED"}},
        {CUIAHelper::SwitchNumber3PressedEvent, QLatin1String{"SWITCH_NUMBER_3_PRESSED"}},
        {CUIAHelper::SwitchNumber3ReleasedEvent, QLatin1String{"SWITCH_NUMBER_3_RELEASED"}},
        {CUIAHelper::SwitchNumber4PressedEvent, QLatin1String{"SWITCH_NUMBER_4_PRESSED"}},
        {CUIAHelper::SwitchNumber4ReleasedEvent, QLatin1String{"SWITCH_NUMBER_4_RELEASED"}},
        {CUIAHelper::SwitchNumber5PressedEvent, QLatin1String{"SWITCH_NUMBER_5_PRESSED"}},
        {CUIAHelper::SwitchNumber5ReleasedEvent, QLatin1String{"SWITCH_NUMBER_5_RELEASED"}},
        {CUIAHelper::TrackPreviousEvent, QLatin1String{"TRACK_PREVIOUS"}},
        {CUIAHelper::TrackNextEvent, QLatin1String{"TRACK_NEXT"}},
        {CUIAHelper::SwitchGlobalPressedEvent, QLatin1String{"SWITCH_GLOBAL_PRESSED"}},
        ...
        {CUIAHelper::SwitchKnob3PressedEvent, QLatin1String{"SWITCH_KNOB3_PRESSED"}},
