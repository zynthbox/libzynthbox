...
public:
    ...
    const QHash<CUIAHelper::Event, QString> titles{
        ...
        {CUIAHelper::SwitchRecordDownEvent, QLatin1String{"Press Record Button"}},
        ...
        {CUIAHelper::SwitchArrowUpDownEvent, QLatin1String{"Press Arrow Up Button"}},
        {CUIAHelper::SwitchArrowUpReleasedEvent, QLatin1String{"Release Arrow Up Button"}},
        {CUIAHelper::SwitchArrowDownDownEvent, QLatin1String{"Press Arrow Down Button"}},
        {CUIAHelper::SwitchArrowDownReleasedEvent, QLatin1String{"Release Arrow Down Button"}},
        {CUIAHelper::SwitchArrowLeftDownEvent, QLatin1String{"Press Arrow Left Button"}},
        {CUIAHelper::SwitchArrowLeftReleasedEvent, QLatin1String{"Release Arrow Left Button"}},
        {CUIAHelper::SwitchArrowRightDownEvent, QLatin1String{"Press Arrow Right Button"}},
        ...
        {CUIAHelper::SwitchBackDownEvent, QLatin1String{"Press Back Button"}},
        ...
        {CUIAHelper::SwitchRecordDownEvent, QLatin1String{"Press Record Button"}},
        {CUIAHelper::SwitchRecordReleasedEvent, QLatin1String{"Release Record Button"}},
        {CUIAHelper::SwitchMetronomeDownEvent, QLatin1String{"Press Metronome Button"}},
        {CUIAHelper::SwitchMetronomeReleasedEvent, QLatin1String{"Release Metronome Button"}},
        {CUIAHelper::SwitchPlayDownEvent, QLatin1String{"Press Play Button"}},
        {CUIAHelper::SwitchPlayReleasedEvent, QLatin1String{"Release Play Button"}},
        {CUIAHelper::SwitchStopDownEvent, QLatin1String{"Press Stop Button"}},
        ...
        {CUIAHelper::SwitchNumber1DownEvent, QLatin1String{"Press Number 1 Button"}},
        {CUIAHelper::SwitchNumber1ReleasedEvent, QLatin1String{"Release Number 1 Button"}},
        {CUIAHelper::SwitchNumber2DownEvent, QLatin1String{"Press Number 2 Button"}},
        {CUIAHelper::SwitchNumber2ReleasedEvent, QLatin1String{"Release Number 2 Button"}},
        {CUIAHelper::SwitchNumber3DownEvent, QLatin1String{"Press Number 3 Button"}},
        {CUIAHelper::SwitchNumber3ReleasedEvent, QLatin1String{"Release Number 3 Button"}},
        {CUIAHelper::SwitchNumber4DownEvent, QLatin1String{"Press Number 4 Button"}},
        {CUIAHelper::SwitchNumber4ReleasedEvent, QLatin1String{"Release Number 4 Button"}},
        {CUIAHelper::SwitchNumber5DownEvent, QLatin1String{"Press Number 5 Button"}},
    ...
    const QHash<CUIAHelper::Event, QString> commands{
        ...
        {CUIAHelper::SwitchArrowUpDownEvent, QLatin1String{"SWITCH_ARROW_UP_DOWN"}},
        {CUIAHelper::SwitchArrowUpReleasedEvent, QLatin1String{"SWITCH_ARROW_UP_DOWN"}},
        {CUIAHelper::SwitchArrowDownDownEvent, QLatin1String{"SWITCH_ARROW_DOWN_DOWN"}},
        {CUIAHelper::SwitchArrowDownReleasedEvent, QLatin1String{"SWITCH_ARROW_DOWN_RELEASED"}},
        {CUIAHelper::SwitchArrowLeftDownEvent, QLatin1String{"SWITCH_ARROW_LEFT_DOWN"}},
        {CUIAHelper::SwitchArrowLeftReleasedEvent, QLatin1String{"SWITCH_ARROW_LEFT_RELEASED"}},
        {CUIAHelper::SwitchArrowRightDownEvent, QLatin1String{"SWITCH_ARROW_RIGHT_DOWN"}},
        ...
        {CUIAHelper::SwitchBackDownEvent, QLatin1String{"SWITCH_BACK_RELEASED"}},
        ...
        {CUIAHelper::SwitchSelectDownEvent, QLatin1String{"SWITCH_SELECT_DOWN"}},
        ...
        {CUIAHelper::SwitchRecordDownEvent, QLatin1String{"SWITCH_RECORD_DOWN"}},
        {CUIAHelper::SwitchRecordReleasedEvent, QLatin1String{"SWITCH_RECORD_RELEASED"}},
        {CUIAHelper::SwitchMetronomeDownEvent, QLatin1String{"SWITCH_METRONOME_DOWN"}},
        {CUIAHelper::SwitchMetronomeReleasedEvent, QLatin1String{"SWITCH_METRONOME_RELEASED"}},
        {CUIAHelper::SwitchPlayDownEvent, QLatin1String{"SWITCH_PLAY_DOWN"}},
        {CUIAHelper::SwitchPlayReleasedEvent, QLatin1String{"SWITCH_PLAY_RELEASED"}},
        {CUIAHelper::SwitchStopDownEvent, QLatin1String{"SWITCH_STOP_DOWN"}},
        ...
        {CUIAHelper::SwitchNumber1DownEvent, QLatin1String{"SWITCH_NUMBER_1_DOWN"}},
        {CUIAHelper::SwitchNumber1ReleasedEvent, QLatin1String{"SWITCH_NUMBER_1_RELEASED"}},
        {CUIAHelper::SwitchNumber2DownEvent, QLatin1String{"SWITCH_NUMBER_2_DOWN"}},
        {CUIAHelper::SwitchNumber2ReleasedEvent, QLatin1String{"SWITCH_NUMBER_2_RELEASED"}},
        {CUIAHelper::SwitchNumber3DownEvent, QLatin1String{"SWITCH_NUMBER_3_DOWN"}},
        {CUIAHelper::SwitchNumber3ReleasedEvent, QLatin1String{"SWITCH_NUMBER_3_RELEASED"}},
        {CUIAHelper::SwitchNumber4DownEvent, QLatin1String{"SWITCH_NUMBER_4_DOWN"}},
        {CUIAHelper::SwitchNumber4ReleasedEvent, QLatin1String{"SWITCH_NUMBER_4_RELEASED"}},
        {CUIAHelper::SwitchNumber5DownEvent, QLatin1String{"SWITCH_NUMBER_5_DOWN"}},
