...
public:
    ...
    enum Event {
        ...
        SwitchNumber1DownEvent,
        SwitchNumber1ReleasedEvent,
        SwitchNumber2DownEvent,
        SwitchNumber2ReleasedEvent,
        SwitchNumber3DownEvent,
        SwitchNumber3ReleasedEvent,
        SwitchNumber4DownEvent,
        SwitchNumber4ReleasedEvent,
        SwitchNumber5DownEvent,
        ...
        SwitchRecordDownEvent,
        SwitchRecordReleasedEvent,
        SwitchMetronomeDownEvent,
        ...
        SwitchArrowUpDownEvent,
        SwitchArrowUpReleasedEvent,
        SwitchSelectDownEvent,
        SwitchSelectReleasedEvent,
        SwitchArrowLeftDownEvent,
        SwitchArrowLeftReleasedEvent,
        SwitchArrowDownDownEvent,
        SwitchArrowDownReleasedEvent,
        SwitchArrowRightDownEvent,
