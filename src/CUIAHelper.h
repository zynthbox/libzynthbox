...
public:
    ...
    enum Event {
        ...
        SwitchMenuPressedEvent,
        SwitchMenuReleasedEvent,
        SwitchNumber1PressedEvent,
        SwitchNumber1ReleasedEvent,
        SwitchNumber2PressedEvent,
        SwitchNumber2ReleasedEvent,
        SwitchNumber3PressedEvent,
        SwitchNumber3ReleasedEvent,
        SwitchNumber4PressedEvent,
        SwitchNumber4ReleasedEvent,
        SwitchNumber5PressedEvent,
        SwitchNumber5ReleasedEvent,
        SwitchStarPressedEvent,
        SwitchStarReleasedEvent,
        SwitchModePressedEvent,
        SwitchModeReleasedEvent,

        // Step buttons
        SwitchStep1PressedEvent,
        SwitchStep1ReleasedEvent,
        SwitchStep2PressedEvent,
        SwitchStep2ReleasedEvent,
        SwitchStep3PressedEvent,
        SwitchStep3ReleasedEvent,
        SwitchStep4PressedEvent,
        SwitchStep4ReleasedEvent,
        SwitchStep5PressedEvent,
        SwitchStep5ReleasedEvent,
        SwitchStep6PressedEvent,
        SwitchStep6ReleasedEvent,
        SwitchStep7PressedEvent,
        SwitchStep7ReleasedEvent,
        SwitchStep8PressedEvent,
        SwitchStep8ReleasedEvent,
        SwitchStep9PressedEvent,
        SwitchStep9ReleasedEvent,
        SwitchStep10PressedEvent,
        SwitchStep10ReleasedEvent,
        SwitchStep11PressedEvent,
        SwitchStep11ReleasedEvent,
        SwitchStep12PressedEvent,
        SwitchStep12ReleasedEvent,
        SwitchStep13PressedEvent,
        SwitchStep13ReleasedEvent,
        SwitchStep14PressedEvent,
        SwitchStep14ReleasedEvent,
        SwitchStep15PressedEvent,
        SwitchStep15ReleasedEvent,
        SwitchStep16PressedEvent,
        SwitchStep16ReleasedEvent,

        // Modifier
        SwitchAltPressedEvent,
        SwitchAltReleasedEvent,

        // Bottom left-hand side cluster (playback control)
        SwitchRecordPressedEvent,
        SwitchRecordReleasedEvent,
        SwitchMetronomePressedEvent,
        SwitchMetronomeReleasedEvent,
        SwitchPlayPressedEvent,
        SwitchPlayReleasedEvent,
        SwitchStopPressedEvent,
        SwitchStopReleasedEvent,

        // Bottom right-hand side cluster (navigation)
        SwitchBackPressedEvent,
        SwitchBackReleasedEvent,
        SwitchArrowUpPressedEvent,
        SwitchArrowUpReleasedEvent,
        SwitchSelectPressedEvent,
        SwitchSelectReleasedEvent,
        SwitchArrowLeftPressedEvent,
        SwitchArrowLeftReleasedEvent,
        SwitchArrowDownPressedEvent,
        SwitchArrowDownReleasedEvent,
        SwitchArrowRightPressedEvent,
        SwitchArrowRightReleasedEvent,

        // Controls on the right-hand side of the display
        SwitchGlobalPressedEvent,
